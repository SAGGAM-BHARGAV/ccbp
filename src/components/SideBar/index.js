      ...
      {value => {
        ...
        return (
          <SideBarContainer>
            <NavItemsContainer>
              <TextItemContainer
                isActive={activeTab === 'HOME' ? bgColor : 'transparent'}
              ...
              >
                ...
                >
                  <AiFillHome />
                  <ItemText color={activeTab === 'HOME' ? '#ff0000' : bgColor}>
                    Home
                  </ItemText>
                </NavLink>
              </TextItemContainer>
              ...
              <TextItemContainer
                isActive={activeTab === 'TRENDING' ? bgColor : 'transparent'}
              ...
              <TextItemContainer
                isActive={activeTab === 'GAMING' ? bgColor : 'transparent'}
